// API base URL - prefer VITE_BACKEND_URL or VITE_API_BASE_URL, fall back to VITE_API_URL or localhost
const API_URL = import.meta.env.VITE_BACKEND_URL || import.meta.env.VITE_API_BASE_URL || import.meta.env.VITE_API_URL || "http://localhost:8000";
