...
const steps = [{
  number: "1",
  icon: Upload,
  title: "Elige un picto",
  description: "Elige un pictograma inicial",
  color: "primary"
}, {
  number: "2",
  icon: Sparkles,
  title: "Magia de IA",
  description: "Nuestra inteligencia artificial analiza y predice los siguientes pictogramas ",
  color: "secondary"
}, {
  number: "3",
  icon: Download,
  title: "¡Chatea!",
  description: "Usa nuestro predictor para comunicarte de forma efectiva",
  color: "accent"
}];
const HowItWorks = () => {
